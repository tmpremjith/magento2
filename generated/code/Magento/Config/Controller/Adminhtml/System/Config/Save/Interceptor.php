...
class Interceptor extends \Magento\Config\Controller\Adminhtml\System\Config\Save implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_saveState');
        return $pluginInfo ? $this->___callPlugins('_saveState', func_get_args(), $pluginInfo) : parent::_saveState($configState);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterNodes');
        return $pluginInfo ? $this->___callPlugins('filterNodes', func_get_args(), $pluginInfo) : parent::filterNodes($configData);
    }
