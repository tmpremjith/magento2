<?php
namespace Magento\Elasticsearch\Model\Config\Backend\MinimumShouldMatch;

/**
 * Interceptor class for @see \Magento\Elasticsearch\Model\Config\Backend\MinimumShouldMatch
 */
class Interceptor extends \Magento\Elasticsearch\Model\Config\Backend\MinimumShouldMatch implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function validateValue() : void
    {
        ...
        $pluginInfo ? $this->___callPlugins('validateValue', func_get_args(), $pluginInfo) : parent::validateValue();
    }
