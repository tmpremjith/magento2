...
class Interceptor extends \Magento\CheckoutAgreements\Model\ResourceModel\Agreement\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsStoreFilterWithAdmin');
        return $pluginInfo ? $this->___callPlugins('setIsStoreFilterWithAdmin', func_get_args(), $pluginInfo) : parent::setIsStoreFilterWithAdmin($value);
    }
