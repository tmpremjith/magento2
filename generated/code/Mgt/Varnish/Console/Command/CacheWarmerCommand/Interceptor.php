...
class Interceptor extends \Mgt\Varnish\Console\Command\CacheWarmerCommand implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function crawlUrls(array $urls, \Symfony\Component\Console\Output\OutputInterface $output)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'crawlUrls');
        return $pluginInfo ? $this->___callPlugins('crawlUrls', func_get_args(), $pluginInfo) : parent::crawlUrls($urls, $output);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'deleteFromQueue');
        return $pluginInfo ? $this->___callPlugins('deleteFromQueue', func_get_args(), $pluginInfo) : parent::deleteFromQueue($urls);
    }
